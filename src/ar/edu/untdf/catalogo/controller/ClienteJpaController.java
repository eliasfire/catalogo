...
public class ClienteJpaController implements Serializable {
    ...
    public void edit(Cliente cliente) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                int id = (int) cliente.getIdcliente();
    ...
    public void destroy(int codigo) throws NonexistentEntityException {
        ...
        try {
            ...
            Cliente cliente;
            try {
                cliente = em.getReference(Cliente.class, codigo);
    ...
    public Cliente findCliente(int idusuario) {
        EntityManager em = getEntityManager();
        try {
    ...
    public boolean findClienteBooolean(Long id) {
        EntityManager em = getEntityManager();
        try {
